...
const Privacy = () => {
  return (
    <div className="min-h-screen bg-[#faf9f6] text-[#2f3a2f]">
      <header className="border-b border-[#e5e2da] bg-[#faf9f6]">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-5">
          <Link
            to="/"
            className="text-2xl font-semibold tracking-tight text-[#314531]"
          >
            potter.ai
          </Link>
          ...
          <Link
            to="/login"
            className="text-sm font-medium text-[#536653] transition hover:text-[#314531]"
          >
            Back to Potter
          </Link>
        </div>
        ...
        <div className="space-y-10 text-[16px] leading-8 text-[#4d584d]">
          <section>
            ...
            <p className="mt-4">
              ...
              use it, where it is stored, and the choices you have regarding
              your information.
            </p>
          </section>
          ...
          <PolicySection title="1. Information We Collect">
            <PolicySubsection title="Information you provide through Google Sign-In">
              <p>
                When you sign in to Potter.ai using Google, we receive
                information provided by Google that is necessary to create and
                manage your Potter.ai account. This may include:
              </p>
              ...
              <p className="mt-4">
                We use this information to authenticate you, create your
                Potter.ai account, maintain your session, and associate your
                plants and other application data with your account.
              </p>
            ...
            <PolicySubsection title="Plant and application information">
              <p>
                When you use Potter.ai, you may provide information such as:
              </p>
            ...
            <PolicySubsection title="Photos and uploaded files">
              <p>
                ...
                that Potter.ai can provide features such as plant
                identification, health assessment, and plant-history tracking.
              </p>
            </PolicySubsection>
          ...
          <PolicySection title="3. AI Features">
            ...
            <p className="mt-4">
              When you use an AI feature, information you provide to that
              feature, such as plant photographs, plant details, and
              descriptions of a plant concern, may be processed by the AI
              systems used to provide that feature.
            </p>

            <p className="mt-4">
              We will not use your personal information or Google account
              information to train or improve general-purpose AI models unless
              we separately disclose that use and obtain any consent required by
          ...
          <PolicySection title="4. How We Share Your Information">
            ...
            <p className="mt-4">
              We may share or transfer information to service providers that
              help us operate Potter.ai, including providers for:
            </p>
          ...
          <PolicySection title="6. Data Retention">
            <p>
              We retain your account and application data for as long as
              necessary to provide Potter.ai and maintain your account, unless
              you request deletion or a longer retention period is required by
              law.
            </p>
          ...
          <PolicySection title="7. Your Choices and Rights">
            ...
            <p className="mt-4">
              To make a privacy request, contact us using the email address
              below. We may take reasonable steps to verify your identity before
          ...
          <PolicySection title="8. Account and Data Deletion">
            <p>
              You may contact us to request deletion of your Potter.ai account
          ...
          <PolicySection title="10. Third-Party Services">
            <p>
              Potter.ai may rely on third-party services to provide
              functionality such as authentication, cloud storage, hosting, and
              AI processing.
            </p>

            <p className="mt-4">
              Those services may process information on our behalf and are
          ...
          <PolicySection title="12. Contact Us">
            ...
            <div className="mt-5 rounded-2xl border border-[#e5e2da] bg-white px-6 py-5">
              ...
              <p className="mt-1">YOUR_PRIVACY_EMAIL</p>
      ...
      <footer className="border-t border-[#e5e2da]">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-6 text-sm text-[#788178]">
          <span>© {new Date().getFullYear()} Potter.ai</span>

          <Link to="/" className="transition hover:text-[#314531]">
            Potter.ai
          </Link>
        </div>
      </footer>
