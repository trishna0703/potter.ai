      ...
      <main className="mx-auto max-w-4xl px-6 py-12 md:py-16">
        ...
        <div className="space-y-10 text-[16px] leading-8 text-[#4d584d]">
          ...
          <TermsSection title="2. About Potter.ai">
            <p>
              Potter.ai is a plant-care application designed to help you
              organize your plants, record plant-care activities, document
              plant-health concerns, identify plants, and receive AI-powered
              plant-care information and recommendations.
            </p>

            <p className="mt-4">
              Features may change, be added, or be removed as Potter.ai
              develops.
            </p>
          </TermsSection>
          ...
          <TermsSection title="5. Your Content">
            <p>
              You may upload or provide content through Potter.ai, including
              plant photographs, plant information, care records, descriptions,
              and observations (&quot;User Content&quot;).
            </p>
            ...
            <p className="mt-4">
              ...
              content as reasonably necessary to provide and operate the
              service.
            </p>

            <p className="mt-4">
              You are responsible for ensuring that you have the necessary
              rights to upload and use any content you submit.
            </p>
          </TermsSection>
          ...
          <TermsSection title="6. AI-Generated Information">
            ...
            <p className="mt-4">
              AI-generated information may be incomplete, inaccurate, outdated,
              or incorrect. Plant identification and health assessments are not
              guaranteed to be accurate.
            </p>

            <p className="mt-4">
              Information provided by Potter.ai should not be treated as a
              substitute for professional horticultural, agricultural,
              veterinary, medical, or other expert advice.
            </p>
          ...
          <TermsSection title="7. Third-Party Services">
            <p>
              ...
              authentication, cloud storage, hosting, analytics, security, and
              AI processing.
            </p>
          ...
          <TermsSection title="9. Service Availability">
            ...
            <p className="mt-4">
              ...
              updates, infrastructure issues, security incidents, or
          ...
          <TermsSection title="11. Limitation of Liability">
            <p>
              To the maximum extent permitted by applicable law, Potter.ai and
              its operators will not be liable for indirect, incidental,
              special, consequential, or similar damages arising from your use
          ...
          <TermsSection title="13. Changes to These Terms">
            <p>
              We may update these Terms from time to time as Potter.ai evolves
              or as legal or regulatory requirements change.
            </p>
            ...
            <p className="mt-4">
              Your continued use of Potter.ai after updated Terms become
          ...
          <TermsSection title="14. Governing Law">
            <p>
              ...
              the laws applicable to Potter.ai, without regard to
          ...
          <TermsSection title="15. Contact Us">
            ...
            <div className="mt-5 rounded-2xl border border-[#e5e2da] bg-white px-6 py-5">
              ...
              <p className="mt-1">YOUR_CONTACT_EMAIL</p>
      ...
      <footer className="border-t border-[#e5e2da]">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-6 text-sm text-[#788178]">
          ...
          <div className="flex items-center gap-5">
            <Link to="/privacy" className="transition hover:text-[#314531]">
              Privacy Policy
            </Link>
